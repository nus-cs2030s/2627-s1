...
```Java  title="Circle v0.5 with Composition" hl_lines="5 11 12 26"
/**
...
```Java title="Aliasing of Point within Circle"
...
```Java title="Aliasing of Point within Circle with Improved moveTo"
Point p = new Point(0, 0);
Circle c1 = new Circle(p, 1);
Circle c2 = new Circle(p, 4);
...
```Java title="Additional Issue with Cylinder"
...
```Java title="Absence of Reference Sharing"
