...
##### jshell
.content.tight[
.img46.center[![jshell](../img/01-TS-Jshell.png)]
]
]
]
]
...
##### javac + java
.content.tight[
.center.img97[![javac + java](../img/01-TS-Java.png)]
]
]
]
]
...
##### Catch Errors Early
.content.tight[
.center[![Compilation](../img/01-bridge.jpg)]
]
]
]
]
...
.vs10[]
.col37[
![dynamic](../img/01-TS-02.png)
]
.col26[.op0[.]]
.col35[
![static](../img/01-TS-03.png)
]
.vs10[]
.col46[
.card.bg-r.op0[
...
|---|---|---|---|
| Whole numbers | `byte`<br>`short`<br>`int`<br>`long` | 8-bits<br>16-bits<br>32-bits<br>64-bits | `0`<br>`0`<br>`0`<br>`0L` |
| Floating-point | `float`<br>`double` | 32-bits<br>64-bits | `0.0f`<br>`0.0` |
| Characters | `char` | 16-bits | `''` .note18[(i.e., empty)] |
| Boolean | `boolean` | _JVM dependent_ | `false` |
]
]
]
]
...
- How can you say that an object is a circle or not?
]
]
]
]
...
.col100[
.img60.center[![Circle](../img/01-circle.png)]
]
]
